...
ScrollReveal().reveal('.home .info h2, .section-title-01, .section-title-02 a',{ delay: 500, origin: 'left'});
...
ScrollReveal().reveal('.footer-content p', { delay: 500, origin: 'bottom' });
